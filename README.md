...
Безопасность веб-приложения обеспечена использованием Spring Security и JWT токена. Время жизни токена доступа 15 миинут, 
а время жизни токена обновления 1 день. В качестве базы данных использован PostgreSQL. Для управления миграциями 
базы данных использован Flyway.
